...
const VerifyPhone14 = () => {
    return (
        <div className="verify-phone14">
            ...
            <div className="verifiedcard14">
                <div className="verify14">
                    <div className="VerifyBox14" />
                    <b className="phone-number-verifie">Phone Number Verified</b>
                </div>
            </div>
            <img className="checked-4-icon" alt="" src={CheckedIcon}/>
        </div>
    );
};

export default VerifyPhone14;
